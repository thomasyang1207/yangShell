...
#line 3 "calculator.y" /* yacc.c:339  */
...
{
  "$end", "error", "$undefined", "INTEGER", "'+'", "'-'", "$accept",
  "goal", "statement", "addStatement", "subStatement", YY_NULLPTR
};
#endif
...
#line 29 "calculator.y" /* yacc.c:1906  */
